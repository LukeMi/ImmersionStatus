package com.lukemi.statubarapp.widget;
...
import com.lukemi.statubarapp.R;
        ...
        setmOnIndexPressedListener(new OnIndexPressedListener() {
            ...
            public void onIndexPressed(int index, String text) {
                if (mPressedShowTextView != null) { //显示hintTexView
                    if (mPressedShowTextView.getVisibility() != View.VISIBLE) {
...
//        mDataHelper = new IndexBarDataHelperImpl();
   ...
   /* */
     ...
     * @param indexArray
     */
    public void setIndexString(@ArrayRes int indexArray) {
        String[] stringArray = getResources().getStringArray(indexArray);
        INDEX_STRING = stringArray;
        invalidate();
    }
/*
